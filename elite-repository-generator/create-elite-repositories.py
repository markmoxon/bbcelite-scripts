...
sites = [
    ...
    },
    {
        ...
        "source_files": ["elite-text-tokens.asm", "elite-missile.asm", "elite-loader1.asm", "elite-loader2.asm", "elite-loader3.asm", "elite-loading-screen.asm", "elite-loader-sideways-ram.asm", "elite-source-flight.asm", "elite-ships-a.asm", "elite-ships-b.asm", "elite-ships-c.asm", "elite-ships-d.asm", "elite-ships-e.asm", "elite-ships-f.asm", "elite-ships-g.asm", "elite-ships-h.asm", "elite-ships-i.asm", "elite-ships-j.asm", "elite-ships-k.asm", "elite-ships-l.asm", "elite-ships-m.asm", "elite-ships-n.asm", "elite-ships-o.asm", "elite-ships-p.asm", "elite-disc.asm", "elite-readme.asm"],
        "do_not_expand_includes": ["elite-build-options.asm"],
    ...
    },
    {
        ...
        "source_files": ["elite-loader.asm", "elite-loading-screen.asm", "elite-source.asm", "elite-bcfs.asm", "elite-disc.asm", "elite-readme.asm"],
        "do_not_expand_includes": ["elite-build-options.asm"],
