...
find $ELITE_CODE_REPOSITORIES/elite-source-code-commodore-64/1-source-files/main-sources -maxdepth 1 -name '*.asm' -type f -exec wc {} \; >> temp.txt
find $ELITE_CODE_REPOSITORIES/elite-source-code-apple-ii/1-source-files/main-sources -maxdepth 1 -name '*.asm' -type f -exec wc {} \; >> temp.txt
...
saveIFS="$IFS"
IFS=$'\n'
find $THE_SENTINEL_CODE_REPOSITORY/1-source-files/main-sources -maxdepth 1 -name '*.asm' -type f -exec wc {} \; >> temp.txt
IFS="$saveIFS"
...
find $ELITE_CODE_REPOSITORIES/elite-source-code-commodore-64/1-source-files/main-sources -maxdepth 1 -name '*.asm' -type f -exec perl strip_code_nes.pl {} \; >> temp.txt
find $ELITE_CODE_REPOSITORIES/elite-source-code-apple-ii/1-source-files/main-sources -maxdepth 1 -name '*.asm' -type f -exec perl strip_code_nes.pl {} \; >> temp.txt
...
saveIFS="$IFS"
IFS=$'\n'
find $THE_SENTINEL_CODE_REPOSITORY/1-source-files/main-sources -maxdepth 1 -name '*.asm' -type f -exec perl strip_code.pl {} \; >> temp.txt
IFS="$saveIFS"
